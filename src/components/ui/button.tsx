  ...
  "inline-flex items-center justify-center whitespace-nowrap rounded-xl text-sm font-medium ring-offset-background transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        ...
        premium: "btn-premium",
        glass: "glass hover:glass-elevated border border-glass-border text-text-primary hover:text-accent-neon",
        neon: "bg-gradient-to-r from-accent-neon to-accent-blue text-white hover:from-accent-blue hover:to-accent-purple shadow-lg hover:shadow-neon transition-all duration-300",
      },
      size: {
