...
export const IMAGE_ASSETS = {
  hero: '/testpics/herodesktop.jpeg',
  heroBackground: '/testpics/imageskintexturebackground.jpg',
  beforeAfterPairs: [
    {
    ...
    {
      before: '/testpics/Asian+Man+1+Before.jpg',
      after: '/testpics/Asian+Man+1+After.png',
    ...
    {
      before: '/testpics/Face+1+Before.jpg',
      after: '/testpics/Face+1+After.png',
    ...
    {
      before: '/testpics/Girl+2+Before (1).jpg',
      after: '/testpics/Girl+2+After.png',
      title: 'Professional Portrait',
    },
    {
      before: '/testpics/White+Girl+6+before.jpg',
      after: '/testpics/White+Girl+6+after.jpg',
    ...
    {
      before: '/testpics/LilMiquela+before.png',
      after: '/testpics/LilMiquela+after.png',
      title: 'Digital Avatar Enhancement',
    },
    {
      before: '/testpics/Anita+Before.jpg.webp',
      after: '/testpics/Anita+After.png',
      title: 'Portrait Refinement',
    },
  ],
  aiModels: [
    { name: 'Adobe Firefly', image: '/testpics/Adobe Firefly.png' },
    { name: 'DALL-E', image: '/testpics/Dalle.png' },
    { name: 'Flux', image: '/testpics/Flux.png' },
    { name: 'Midjourney', image: '/testpics/Midjourney2.png' },
    { name: 'Stability AI', image: '/testpics/stability.png' },
    { name: 'Grok', image: '/testpics/grok.png' },
  ],
  featured: [
    '/testpics/Tove1.png',
    '/testpics/Tove2.png',
  ...
  backgrounds: [
    '/testpics/4kresolution.png',
    '/testpics/b-roll.jpeg',
    '/testpics/ladypink.png',
    '/testpics/lipme.png',
  ],
} as const;
...
export const TESTIMONIALS = [
  {
    ...
    avatar: '/testpics/Asian+Girl+7+after.png',
    rating: 5,
  ...
  },
  {
    ...
    avatar: '/testpics/Black+Man+1+After.png',
    rating: 5,
  ...
  },
  {
    ...
    avatar: '/testpics/Girl+1+After.png',
    rating: 5,
  ...
  },
  {
    ...
    avatar: '/testpics/Asian+Man+1+After.png',
    rating: 5,
